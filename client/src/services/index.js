...
export const trainerService = {
  ...
  addMember: (data) => api.post('/trainer/members', data),
...
export const workoutService = {
  ...
  assignWorkout: (memberId, data) => api.post(`/workout/assign/${memberId}`, data),
  updateWorkout: (workoutId, data) => api.put(`/workout/${workoutId}`, data),
  deleteWorkout: (workoutId) => api.delete(`/workout/${workoutId}`),
  aiGenerate: (memberId, data) => api.post(`/workout/ai-generate/${memberId}`, data),
...
export const dietService = {
  ...
  aiGenerate: (memberId, data) => api.post(`/diet/ai-generate/${memberId}`, data),
...
export const memberService = {
  ...
  getInbox: () => api.get('/member/messages'),
